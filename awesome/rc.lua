...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control" }, "j", function () awful.screen.focus_relative( 1) end,
              {description = "focus the next screen", group = "multi monitor"}),
    awful.key({ modkey, "Control" }, "k", function () awful.screen.focus_relative(-1) end,
              {description = "focus the previous screen", group = "multi monitor"}),
    ...
    awful.key({ modkey },            "b",
        function () awful.util.spawn("zen-browser") end,
              {description = "Open zen-browser", group = "launcher"}),
   ...
   awful.key({ modkey, "Shift" },   "a",
        function() awful.spawn.with_shell("feh --no-fehbg --bg-scale --randomize ~/Pictures/BackgroundImages/currentRandom/*") end,
...
awful.spawn.with_shell("xrandr --output eDP1 --brightness 0.8")
